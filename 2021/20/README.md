...
Start with the original input image and apply the image enhancement algorithm twice, being careful to account for the infinite size of the images. __How many pixels are lit in the resulting image?__
...
Start again with the original input image and apply the image enhancement algorithm 50 times. __How many pixels are lit in the resulting image?__
