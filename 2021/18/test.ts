...
import { parseInput, solvePart1, explode, split, reduce, formatMap, sum, sumReduce, magnitude} from "./solutions.ts";
...
// Deno.test("explode - constructed test case", () => {
//   const input = parseInput(new Input("[[[[8,[[5,6],8]]]]]"));
//   explode(input[0])
//   const result = formatMap(input[0]);
//   assertEquals(result, "[[3,[2,[8,0]]],[9,[5,[4,[3,2]]]]]");
// });
