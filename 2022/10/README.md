...
So, by [carefully](https://en.wikipedia.org/wiki/Racing_the_Beam) timing (_While you're at it, go watch everything else by Retro Game Mechanics Explained, too._) the CPU instructions and the CRT drawing operations, you should be able to determine whether the sprite is visible the instant each pixel is drawn. If the sprite is positioned such that one of its three pixels is the pixel currently being drawn, the screen produces a __lit__ pixel (`#`); otherwise, the screen leaves the pixel __dark__ (`.`).
