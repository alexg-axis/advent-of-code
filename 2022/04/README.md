...
It seems like there is still quite a bit of duplicate work planned. Instead, the Elves would like (_If you like this, you'll *love* axis-aligned bounding box intersection testing._) to know the number of pairs that __overlap at all__.
